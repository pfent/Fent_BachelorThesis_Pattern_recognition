...
\begin{figure}
    ...
    \caption{Detected peaks in sensor measurements (marked in red), as described in Section~\ref{subsection:featureextraction} [own work]}
...
\begin{figure}
    ...
    \caption{Model of touches on Android devices [own work]}
